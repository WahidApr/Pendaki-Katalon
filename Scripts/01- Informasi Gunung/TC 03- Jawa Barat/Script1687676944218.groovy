...
Mobile.tap(findTestObject('Object Repository/01- Informasi Gunung_Features/3- Jawa Barat_Features'), 0)

Mobile.scrollToText('Gunung Salak')

Mobile.verifyElementVisible(findTestObject('Object Repository/01- Informasi Gunung_Features/3.1- Jawa Barat_Assertion'), 0)
