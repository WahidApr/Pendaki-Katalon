...
Mobile.tap(findTestObject('Object Repository/02- Informasi Pendakian_Features/7- Jawa Barat_Features'), 0)

Mobile.getText(findTestObject('Object Repository/02- Informasi Pendakian_Features/7.1- Jawa Barat_Assertion'), 0)
